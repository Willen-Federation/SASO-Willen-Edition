  ...
  <form action="./member/edit/" method="POST">
    ...
    <div class="p-6.5">
      ...
      <div class="mb-4.5">
        ...
        <input type="text" name="userName" value="<?php echo htmlspecialchars($v->member->name); ?>" placeholder="Enter display name" class="w-full rounded border-[1.5px] border-gray-200 bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-gray-800 dark:bg-form-input dark:focus:border-primary" required>
      </div>
