  ...
  <section class="rounded-sm border border-gray-200 bg-white shadow-default dark:border-gray-800 dark:bg-boxdark">
    ...
    <div class="p-6 space-y-4">
      ...
      <div class="rounded border border-dashed border-brand-400 bg-brand-50 dark:bg-brand-900/10 p-4">
        ...
        <p id="env_firebase_paste_feedback" class="mt-1.5 hidden text-xs font-medium text-success"></p>
        <p id="env_firebase_paste_error" class="mt-1.5 hidden text-xs font-medium text-error-500"></p>
      </div>
...
<script>
(function () {
  var textarea = document.getElementById('env_firebase_config_paste');
  var feedback = document.getElementById('env_firebase_paste_feedback');
  var errorEl  = document.getElementById('env_firebase_paste_error');

  // env-settings uses different input IDs
  var fieldMap = {
