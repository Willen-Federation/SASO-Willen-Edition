    ...
    'body' => function () use ($drafts, $lang, $statusLabels, $statusClasses) {
      if (empty($drafts)): ?>
        <div class="flex flex-col items-center gap-3 py-12 text-gray-500 dark:text-gray-400">
          <svg class="h-12 w-12 text-stroke" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
          ...
          <table class="w-full table-auto text-left text-sm">
            ...
            <tbody>
              ...
              <tr class="border-b border-stroke dark:border-strokedark hover:bg-gray-50 dark:hover:bg-meta-4 transition">
                <td class="px-4 py-3">
                  <?php if ($imagePath): ?>
                    <img src="./<?php echo $imagePath; ?>"
                         ...
                         class="h-14 w-14 rounded object-cover border border-stroke dark:border-strokedark"
                         loading="lazy">
                  <?php else: ?>
                    <div class="flex h-14 w-14 items-center justify-center rounded border border-stroke bg-gray-2 dark:border-strokedark dark:bg-meta-4">
                ...
                <td class="px-4 py-3 text-body dark:text-bodydark">
                  <?php echo $barcodeHint ?: '<span class="text-gray-400">—</span>'; ?>
                </td>
                <td class="px-4 py-3 text-body dark:text-bodydark whitespace-nowrap">
