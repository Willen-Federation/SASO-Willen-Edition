...
final class ChangePriceDIContainer implements DIContainer
{
    use Flow;
    ...
    {
        $this->ctrl = new ItemController($query, new ChangePriceController($post, $now));
        if(empty($post)) {
            ...
            $this->usecase = new ChangePriceUsecase(
                new DbFinder(),
                new DbUpdater(),
                new DbTransaction(),
