        ...
        $groups = [
            ...
            [
                ...
                'items' => $filterItems([
                    ...
                    ['key' => 'notifications', 'label' => $t('ui.sidebar.notifications',      'Notifications'),  'description' => $d('ui.dashboard.notifications_help', 'Send push notifications to mobile apps.'),    'href' => $base.'admin/notifications/',   'icon' => $svg('bell'),     'permission' => 'settingAdmin'],
