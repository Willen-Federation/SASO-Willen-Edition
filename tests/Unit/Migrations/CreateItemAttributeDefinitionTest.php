...
final class CreateItemAttributeDefinitionTest extends TestCase
{
    private const FILE  = __DIR__.'/../../../migrations/M6/20260427120003_create_item_attribute_definition.php';
    private const CLASS_NAME = 'CreateItemAttributeDefinition';
    ...
    {
        require_once self::FILE;
        self::assertTrue((new ReflectionClass(self::CLASS_NAME))->isSubclassOf(AbstractMigration::class));
    }
