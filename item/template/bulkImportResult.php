    ...
    <div class="px-5 py-5">
      <div class="flex gap-8 mb-5">
        <div class="text-center">
          <div class="text-3xl font-bold" style="color:#16a34a"><?php echo (int) $v->successCount; ?></div>
          <div class="text-sm mt-1" style="color:var(--saso-text-sub)">成功</div>
        </div>
        <div class="text-center">
          <div class="text-3xl font-bold" style="color:#dc2626"><?php echo (int) $v->errorCount; ?></div>
          ...
          <tr>
            ...
            <td class="text-sm">
              ...
              <a href="./item/start/item/<?php echo htmlspecialchars((string) ($r['itemId'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>/"
                 class="font-mono underline" style="color:#3c50e0">
